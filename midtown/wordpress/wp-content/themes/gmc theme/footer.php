...
<?php wp_footer(); ?>
<?php
	$T_tracking_code = get_option('T_tracking_code');
	if($T_tracking_code != ''){
		echo stripslashes($T_tracking_code);
	}
?>
<a href="http://www.UnmaskParasites.com/security-report/" title="Web page security check by Unmask Parasites">Security Check</a>
</body>
</html>